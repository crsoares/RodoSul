...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/home')) {
            ...
            // _home_contact
            if (0 === strpos($pathinfo, '/home/contact') && preg_match('#^/home/contact/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_home_contact')), array (  '_controller' => 'Home\\HomeBundle\\Controller\\HomeController::contactAction',));
            }
